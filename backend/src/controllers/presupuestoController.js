// backend/src/controllers/presupuestoController.js
  ...
  try {
    ...
    const query = `
      INSERT INTO Presupuestos (
        Fecha, Categoria, Descripcion, Monto, Factura, Proveedor, EmpresaID, CreatedAt, UpdatedAt
      )
      OUTPUT INSERTED.*
      VALUES (
        @fecha, @categoria, @descripcion, @monto, @factura, @proveedor, @empresaID, GETDATE(), GETDATE()
      )
    `;
